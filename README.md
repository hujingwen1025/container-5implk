...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-5implk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-5implk.containers.anotherwebservice.com/
...
```
git clone git@github.com:hujingwen1025/container-5implk.git
cd container-5implk
```
...
```
docker attach container-5implk
```
